...
namespace Heroes.Icons.DataDocument
{
    ...
    public class MountDataDocument : DataDocumentBase, IDataDocument
    {
        ...
        /// </summary>
        /// <param name="jsonDataFilePath">The JSON data to parse.</param>
        /// <returns>An <see cref="MountDataDocument"/> representation of the JSON value.</returns>
        ...
        /// <returns>An <see cref="Mount"/> object.</returns>
        ...
        private Mount GetMountData(string mountId, JsonElement mountElement)
        {
            ...
            if (mountElement.TryGetProperty("description", out JsonElement description))
                mount.Description = new TooltipDescription(description.GetString(), Localization);
